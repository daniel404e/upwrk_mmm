...
export default function Loginpage() {
  ...
  const defaultloginvalue = {Email_id:null , Password:null}
  ...
  {
    toast.warn('This Email id is Not Registered, Sign-up now. 😮‍💨', {
      position: "top-center",
      autoClose: 5000,
  ...
  {
    toast.error('Duplicate Records Found, Raise Ticket or Contact support now. 😮‍💨', {
      position: "top-center",
      autoClose: 5000,
      hideProgressBar: false,
      closeOnClick: true,
  ...
  {
    toast.success('Log-in successful , welcome '+json.usernamefromserv+' 😊', {
      position: "top-center",
      autoClose: 5000,
      hideProgressBar: false,
      closeOnClick: true,
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8" >
      {/*
        ...
        ```
          ...
          <input type="email" name="Email_id" placeholder="Email" required  onChange={handleChangelogin} />
